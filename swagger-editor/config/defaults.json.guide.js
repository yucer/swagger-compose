...
var defaults = {
  ...
  */
  codegen: {
     ...
     * endpoint
    */
    servers: '//generator.swagger.local:8081/online/api/gen/servers',
    clients: '//generator.swagger.local:8081/online/api/gen/clients',

    /*
     * For each item in menu item, Swagger Editor will make calls to these
     * endpoint to download the generated code accordingly
    */
    server: '//generator.swagger.local:8081/online/api/gen/servers/{language}',
    client: '//generator.swagger.local:8081/online/api/gen/clients/{language}'
  },
